        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">Visit the <a href="https://feathericons.com/" target="_blank"> Official
                            Feather Icons Documentation </a>.</p>
                    ...
                    <div class="container">
                        <div class="icons-list row">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="alert-octagon"></i> alert-octagon
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="alert-triangle"></i> alert-triangle
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="align-center"></i> align-center </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="align-justify"></i> align-justify
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="arrow-down-circle"></i>
                                arrow-down-circle </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="arrow-down-left"></i> arrow-down-left
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="arrow-down-right"></i>
                                arrow-down-right </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="arrow-down"></i> arrow-down </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="arrow-left-circle"></i>
                                arrow-left-circle </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="arrow-left"></i> arrow-left </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="arrow-right-circle"></i>
                                arrow-right-circle </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="arrow-right"></i> arrow-right </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="arrow-up-circle"></i> arrow-up-circle
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="arrow-up-left"></i> arrow-up-left
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="arrow-up-right"></i> arrow-up-right
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="battery-charging"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="check-circle"></i> check-circle
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="check-square"></i> check-square
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="check"></i> check </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="chevron-down"></i> chevron-down
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="chevron-left"></i> chevron-left
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="chevron-right"></i> chevron-right
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="chevron-up"></i> chevron-up </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="chevrons-down"></i> chevrons-down
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="chevrons-left"></i> chevrons-left
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="chevrons-right"></i> chevrons-right
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="cloud-drizzle"></i> cloud-drizzle
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="cloud-lightning"></i>
                                cloud-lightning </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="corner-down-left"></i>
                                corner-down-left </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="corner-down-right"></i>
                                corner-down-right </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="corner-left-down"></i>
                                corner-left-down </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="corner-left-up"></i> corner-left-up
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="corner-right-down"></i>
                                corner-right-down </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="corner-right-up"></i>
                                corner-right-up </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="corner-up-left"></i> corner-up-left
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="corner-up-right"></i>
                                corner-up-right </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="download-cloud"></i> download-cloud
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="external-link"></i> external-link
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="fast-forward"></i> fast-forward
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="folder-minus"></i> folder-minus
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="git-pull-request"></i>
                                git-pull-request </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="minus-circle"></i> minus-circle
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="minus-square"></i> minus-square
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="more-horizontal"></i>
                                more-horizontal </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="more-vertical"></i> more-vertical
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="mouse-pointer"></i> mouse-pointer
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="navigation-2"></i> navigation-2
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="pause-circle"></i> pause-circle
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="phone-forwarded"></i>
                                phone-forwarded </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="phone-incoming"></i> phone-incoming
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="phone-missed"></i> phone-missed
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="phone-off"></i> phone-off </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="phone-outgoing"></i> phone-outgoing
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="shopping-bag"></i> shopping-bag
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="shopping-cart"></i> shopping-cart
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="skip-forward"></i> skip-forward
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="toggle-right"></i> toggle-right
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="trending-down"></i> trending-down
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3"> <i data-feather="upload-cloud"></i> upload-cloud
                            </div>
