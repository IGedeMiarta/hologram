...
@section('content')
    <div class="row">
        <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
            ...
            <p class="lead">Add dialogs to your site for lightboxes, user notifications, or completely custom content. Read
                the <a href="https://getbootstrap.com/docs/4.5/components/modal/" target="_blank">Official Bootstrap
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
            ...
            <p class="mb-3">Toggle a working modal demo by clicking the button below. It will slide down and fade in from
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
            ...
            <p class="mb-3">When modals become too long for the user’s viewport or device, they scroll independent of the
                page itself.</p>
            <div class="example">
                <!-- Button trigger modal -->
            ...
            <p class="mb-3">Add <code>.modal-dialog-centered</code> to <code>.modal-dialog</code> to vertically center
                the modal.</p>
            <div class="example">
                <!-- Button trigger modal -->
            ...
            <p class="mb-3">Have a bunch of buttons that all trigger the same modal with slightly different contents? Use
                <code>event.relatedTarget</code> and <a
                    href="https://developer.mozilla.org/en-US/docs/Learn/HTML/Howto/Use_data_attributes">HTML
                    <code>data-*</code> attributes</a> (possibly <a href="https://api.jquery.com/data/">via jQuery</a>) to
            ...
            <div class="example">
                ...
                <div class="modal fade" id="varyingModal" tabindex="-1" role="dialog"
