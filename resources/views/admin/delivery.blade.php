                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-warning editSupplier" data-toggle="modal"
                                                ...
                                                data-url="{{ route('admin.delivery.update', $item->id) }}">Edit</button>
    ...
    <div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.delivery.post') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="name">Nama Supplier<i class="text-danger">*</i></label>
                            <input type="text" class="form-control" id="name" autocomplete="off"
                                placeholder="PO Gunung Harta" name="name" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="contact">Kontak Hp<i class="text-danger">*</i></label>
            ...
            <div class="modal-content">
                ...
                <form action="" id="editForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_contact">Kontak Hp<i class="text-danger">*</i></label>
